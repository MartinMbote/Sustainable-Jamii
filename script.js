...
const docImage = document.getElementById('doctor-image-id-test');
const srhrContainer = document.getElementById('SRHR-test');
const readMore1 = document.getElementById('read-more-1-test');
